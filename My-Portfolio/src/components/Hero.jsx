...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center bg-linear-to-br from-slate-900 to-slate-900 pt-20 relative overflow-hidden"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <p
                className={
                  "text-blue-400 font-semibold text-lg transition-all duration-1000"
                }
              >
                Get To Know Me
              </p>
              <h1
                className={
                  "text-5xl md:text-7xl font-black text-white leading-tight transition-all duration-1000 delay-200"
                }
              >
                I'm a
              ...
              <p
                className={
                  "text-gray-300 text-lg leading-relaxed max-w-lg transition-all duration-100 delay-400"
                }
              >
                I’m a passionate Software Engineering student at Melsoft
                Academy, focused on building clean, efficient, and user-friendly
                digital solutions. I love turning ideas into functional web
                experiences and constantly learning new technologies to grow as
                a developer.
              </p>
              <a
                href="https://drive.google.com/uc?export=download&id=1TU2epZn1bDEpogF1MqJ3aq-o42OJ1MAb"
                className="bg-blue-600 text-white px-8 py-4 rounded-lg hover:bg-green-700 transition-all duration-300 inline-flex items-center gap-2 group shadow-lg hover:shadow-xl font-medium hover:scale-105"
              >
                Get My CV
              </a>
