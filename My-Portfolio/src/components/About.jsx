...
function About() {
  return (
    <section  id='about' className='min-h-screen flex items-center bg-linear-to-br from-slate-900 to-slate-900 pt-20 relative overflow-hidden'>
      {/* background design */}
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-space">
              ...
              <div className={`space-y-8 transition all duration-1000 delay-300`}>
                <div className="space-y-4">
                  <p className='text-blue-400 font-semibold text-lg'>About me</p>
                  <h2 className='text-4xl md:text-5xl text-white font-bold animate-slide-up'>Who Am I ?</h2>
                  <p className='text-blue-400 font-semibold delay-200'>Software Engineering Student/ Aspiring Full Stack Developer</p>
                </div>
                ...
                <div className={`grid grid-cols-2 gap-8 py-6 transition-all duration-1000 delay-500`}>
                  <div className="group">
                    <p className='text-white font-semibold group-hover:text-blue-400 transition-all duration'>
                      Name
                    </p>
                ...
                <div className='flex flex-wrap gap-4 transition-all duration-1000 delay-1100'>
                   <a href="https://drive.google.com/uc?export=download&id=1TU2epZn1bDEpogF1MqJ3aq-o42OJ1MAb" download="Brendon's-CV.pdf" className="hidden md:flex items-center gap-2 bg-blue-600 text-white px-6 py-2.5 rounded-lg 
